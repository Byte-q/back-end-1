...
// الحصول على منحة دراسية بواسطة الاسم المستعار (المسار الأصلي)
router.get('/slug/:slug', (req, res) => controller.getScholarshipBySlug(req, res));

// الحصول على منحة دراسية بواسطة الاسم المستعار (مسار إضافي للتوافق مع Next.js)
router.get('/by-slug/:slug', (req, res) => controller.getScholarshipBySlug(req, res));
